...
import pakfoodHead from '../img/pakFood/pakfoodHead.jpg'
...
function PakistaniFood() {
  const pakFood = [
    ...
    },
    {
      ...
      address:
        "Grand Trunk Rd, adjacent Honda Express, Kala Gujran, Jhelum, Punjab",
    ...
    },
    {
      ...
      address:
        "WP4J+X73، Jhelum Bridge، Grand Trunk Road, River Jhelum Mews, Gujrat, Punjab 54000",
      contact: "(0544) 652555",
      image: pakfood9,
    },
    {
      ...
      address:
        "Old G T Rd, Machine Mohalla No.2 Lalazar Colony, Jhelum, Punjab 49600",
      contact: "(0544) 612443",
      image: pakfood10,
    },
    {
    ...
    },
    {
      ...
      address:
        "WPGG+HCW, Railway Rd, Jhelum, Punjab, Jhelum Cantt, Jhelum, Punjab 49600",
      contact: "(0544) 626227",
      image: pakfood12,
    },
    {
      ...
      <div className="bg-sky-100">
        <div class="relative">
          <div
            ...
            style={{
              backgroundImage: `url(${pakfoodHead})`,
